...
# Build the game.
odin build src -define:GameProfile=true -define:DEV_MODE=true -extra-linker-flags:"$EXTRA_LINKER_FLAGS" -show-timings -define:RAYLIB_SHARED=true -build-mode:dll -out:game_tmp$DLL_EXT -debug $VET
